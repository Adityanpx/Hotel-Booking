...
const AddRoom = () => {
  ...
  const onSubmitHandler = async (e) => {
    e.preventDefault();
    //check i f all inputs are filled
  ...
  return (
    <form onSubmit={onSubmitHandler} className="p-4 ml-4">
      <Title
        align="left"
        font="outfit"
        title="Add Room"
      ...
      <div className="w-full flex max-sm:flex-col sm:gap-4 mt-4">
        <div className="flex-1 max-w-48">
          ...
          className="border opacity-70 border-gray-300 mt-1 rounded p-2 w-full">
            ...
            <option value="Faimily Suite">Faimily Suite</option>

          </select>
        </div>
        <div>
          <p className="
          mt-4 text-gray-800">Price <span className="text-xs">/night</span>
          </p>
      ...
      px-8 py-2 rounded mt-8 cursor-pointer" disabled={loading}>
